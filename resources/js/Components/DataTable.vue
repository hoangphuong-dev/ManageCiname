<template>
    <div class="data-table">
        ...
        >
            ...
            >
                <template #header>
                    <div class="font-bold text-blackPrimary-400">
                        {{ field.label }}
                    </div>
                </template>
        ...
        <slot v-if="paginate" name="after">
            <div
                class="card-footer"
                :class="{ 'card-footer--center': footerCenter }"
            >
    ...
    computed: {
        tableInfo() {
            return this.items.length > 0
                ? this.$t("table.table_info", this.paginate)
                : "";
        },
    },
    mounted() {
        ...
        this.$nextTick(() => {
            ...
            if (this.$el.querySelector(".is-scrolling-none") == null) {
                ...
                const tableWidth = table.offsetWidth
                    ...
                    : table.style.width;
                this.$el.querySelector(".scroll-wrapper").style.width =
                    tableWidth;
