<template>
    <div class="w-full flex relative">
        ...
        <div class="w-1/12 text-center">
            <el-button type="danger" @click="exchangePoint()"
                >Đổi điểm</el-button
            >
        </div>
    </div>
            ...
            <el-dialog title="Đổi điểm lấy voucher" v-model="dialogForm">
                ...
                >
                    <div>
                        ...
                        <br />
                        <p>
                            Bạn có thể sử dụng voucher để mua vé khi đã đăng
                            nhập
                        </p>
                    ...
                    <h3>
                        Số điểm khả dụng : {{ member_card.accumulating_point }}
                    </h3>
                    <!-- Nhập điểm quy đổi -->
                    ...
                    <el-form-item prop="chooseVoucher">
                        <el-radio-group v-model="formData.chooseVoucher">
                            <el-radio
                                ...
                                :label="item.type"
                                :disabled="
                                    item.point > member_card.accumulating_point
                                "
