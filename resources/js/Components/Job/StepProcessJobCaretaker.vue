        ...
        const renderStyle = (_, index) => {
            ...
            if(index > 0) {
                style = {
                    ...
                    'padding-left': `${horizontalSpacer * (index - 1) + horizontalSpacer + 6}px`
                }
            }
            return style
        }
...
.active .st-title, .active .st-des, .pending .st-title, .pending .st-des, .reject .st-title, .reject .st-des{
    color: white;
}
...
.un-process .st-title, .un-process .st-des {
    color: #979797;
}
