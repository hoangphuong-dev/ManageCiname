<template>
  <div class="JobCreate px-6 py-5 my-8 bg-white h-full">
    <div class="flex mb-8">
      <h1 class="w-1/2 text-lightGreen">
        {{ job?.id ? "Edit job" : "求人原稿の登録" }}
      </h1>
      <div class="w-1/2 text-right">
        <button
          class="btn-info mr-4"
          @click="$inertia.visit(route('hospital.jobs.list'))"
        >
          キャンセル
        </button>
    ...
    >
      ...
      <div v-show="!showJobProcess" class="job-information w-full">
        ...
        <el-form-item
          label="病院名"
          prop="hospital_name"
          :error="$errors.first('hospital_name')"
        >
          <el-input
        ...
        <div class="flex">
          <div class="w-1/2 pr-2">
            <el-form-item
              ...
              :error="$errors.first('nearest_station')"
            >
              <el-input
                v-model="formData.nearest_station"
                placeholder="Ga gần nhất"
              ></el-input>
            </el-form-item>
          </div>
          <div class="w-1/2 pl-2">
            <el-form-item
              label="ググールマップリンク"
              prop="map_station"
              :error="$errors.first('map_station')"
            >
              <el-input
                v-model="formData.map_station"
                placeholder="Google map liên kết"
              ></el-input>
            </el-form-item>
          </div>
        </div>
        ...
        <div class="block lg:flex">
          <el-form-item class="w-full lg:w-1/2 lg:pr-5" label="給与">
            <div class="flex">
              <el-form-item
                class="w-1/2 pr-1.5"
                prop="wage_min"
                :error="$errors.first('wage_min')"
              >
                <el-input
                  v-model="formData.wage_min"
                  placeholder="Min"
                ></el-input>
                <span class="absolute right-3 top-1/2 text-yellowPrimary"
                  >Yên</span
                >
              </el-form-item>
              <el-form-item
          ...
          <el-form-item class="w-full lg:w-1/2 lg:pl-5" label="年収">
            <div class="flex">
              <el-form-item
                class="w-1/2 pr-1.5"
                prop="annual_income_min"
                :error="$errors.first('annual_income_min')"
              >
                <el-input
                  v-model="formData.annual_income_min"
                  placeholder="Min"
                ></el-input>
                <span class="absolute right-3 top-1/2 text-yellowPrimary"
                  >Yên</span
              ...
              <el-form-item
                class="w-1/2 pl-1.5"
                prop="annual_income_max"
                :error="$errors.first('annual_income_max')"
              >
                <el-input
                  v-model="formData.annual_income_max"
                  placeholder="Max"
                ></el-input>
                <span class="absolute right-3 top-1/2 text-yellowPrimary"
                  >Yên</span
        ...
        <el-form-item
          ...
          label="雇用形態"
          prop="type_of_work"
          :error="$errors.first('type_of_work')"
        >
          <el-radio-group v-model="formData.type_of_work">
            <el-radio class="min-w-132 justify-center" :label="1" border
              >正社員</el-radio
            >
            <el-radio class="min-w-132 justify-center" :label="0" border
              >パートタイム</el-radio
            >
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item
          ...
          label="勤務時間"
          prop="working_hours"
          :error="$errors.first('working_hours')"
        >
        ...
        >
          <el-input
            v-model="formData.number_annual_holidays"
            placeholder="Number of annual holidays"
          ></el-input>
        </el-form-item>
        ...
        <div class="mt-8">
          ...
          <el-form-item
            label="福利厚生・手当"
            prop="experience_priority"
            :error="$errors.first('experience_priority')"
          >
            <el-select
              class="w-full"
              v-model="formData.experience_priority"
              multiple
              placeholder="Experience priority"
            >
              <el-option
                v-for="(item, index) in occupationList"
                :key="index"
        ...
        <div>
          ...
          <div class="flex gap-3">
            <el-form-item
              ...
              label="法人名"
              prop="comapany_name"
              :error="$errors.first('comapany_name')"
            >
              <el-input
                v-model="formData.comapany_name"
          ...
          <el-form-item
            label="法人紹介"
            prop="comapany_introduce"
            :error="$errors.first('comapany_introduce')"
          >
            <el-input
          ...
          <div class="flex flex-wrap mb-2.5">
            ...
            >
              <img
                ...
                class="p-2.5 h-10 w-10 bg-white rounded"
              />
            </button>
          </div>
        </el-form-item>
        <button
          class="mt-4 bg-lightGreen rounded text-white btn-light-green"
...
export default {
  ...
  methods: {
    ...
    async updateJob(jobId) {
      ...
      await updateJob(
        jobId,
        toFormData({ ...this.formData, _method: "PUT" }, "", { indices: true })
      )
        .then(async (res) => {
