        ...
        <div class="w-1/2 m-auto">
          ...
          >
            ...
            <div class="flex w-full">
                ...
                <div class="w-1/12 m-auto mt-8 -mr-8 cursor-pointer" @click="onOpenDialogMovieGenre">
                ...
                >
                  ...
                  <div class="text-right">
                    <span class="dialog-footer">
                      <el-button @click="dialogFormVisibleMovieGenre = false">Hủy</el-button>
                      <el-button type="primary" @click="submitMovieGenre">Thêm</el-button>
                    </span>
                  </div>
                </el-dialog>
              </div>
            ...
            <div class="flex w-full">
                ...
                <div class="w-1/12 m-auto mt-8 -mr-8 cursor-pointer" @click="onOpenDialogCast">
                    <el-icon><circle-plus /></el-icon>
                </div>
            </div>
            <!-- Dialog diễn viên -->
            <div class="customer_dialog">
                ...
                >
                  ...
                  <div class="text-right">
                    <span class="dialog-footer">
                      <el-button @click="dialogFormVisibleCast = false">Hủy</el-button>
...
import { createMovie, createMovieGenre, listMovieGenre, createCast, listCast} from "@/API/main.js";
  ...
  methods: {
    ...
    async submitMovieGenre() {
      this.$refs["movieGenreForm"].validate(async (valid) => {
        if (valid) {
          await createMovieGenre(toFormData({ ...this.formDataMoviegenre }, "", { indices: true }))
            .then(async (res) => {
              this.$message.success("Create success");
              this.fetchDataMovieGenre();
            })
    ...
    async submitCast() {
      this.$refs["CastForm"].validate(async (valid) => {
        if (valid) {
          await createCast(toFormData({ ...this.formDataCast }, "", { indices: true }))
            .then(async (res) => {
              this.$message.success("Create success");
              this.fetchDataCast();
            })
