            ...
            <div class="bg-white min-h-full m-4 mb-0 p-4">
                ...
                <div class="w-full flex relative">
                    ...
                    <div class="w-1/4 text-right">
                        <el-button @click="openDialogFormSeatType"
                            >Thêm Loại ghế</el-button
                        >
                    </div>
                    <!-- dialog lọai ghế  -->
                    <div class="customer_dialog">
                        ...
                        >
                            <el-form
                                ...
                                ref="SeatTypeForm"
                                :model="formDataSeatType"
                                label-position="top"
                                :rules="rulesCast"
                            >
                                <el-form-item label="Loại ghế" prop="name">
                                    <el-input
                                        v-model="formDataSeatType.name"
                                        autocomplete="off"
                                ...
                                <el-form-item
                                    label="Giá tiền loại ghế"
                                    prop="price"
                                >
                                    <el-input
                                        v-model="formDataSeatType.price"
                                        autocomplete="off"
    ...
    methods: {
        handleFileChange(e) {
            ...
            if (files.length) {
                ...
                this.formDataSeatType.image = image;
                reader.readAsDataURL(image);
            }
        },
        openDialogFormSeatType() {
            ...
            this.$refs["SeatTypeForm"].validate(async (valid) => {
                if (valid) {
                    await createSeatType(
                        toFormData({ ...this.formDataSeatType }, "", {
                            indices: true,
                        })
                    )
                        .then(async (res) => {
