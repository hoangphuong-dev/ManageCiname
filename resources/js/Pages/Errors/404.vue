<template>
    <Layout ClassMain="bg-white">
        <div class="flex items-center justify-center page__error">
            <div>
                <svg
                    width="100%"
                    height="100%"
...
<script setup>
import { useScript } from "@/Uses/script";
