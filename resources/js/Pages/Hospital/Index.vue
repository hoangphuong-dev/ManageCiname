    ...
    <div class="py-12">
      <div class="mx-auto messenger-window__custom">
        <div class="w-full">
          ...
          <div class="main-jobs">
            <hospital-job-item v-for="(job, indexJob) in jobs" :key="indexJob" :job="job" :indexJob="indexJob" />
          </div>
        </div>
      </div>
    </div>
...
<script>
import HospitalJobItem from '@/Components/Job/HospitalJobItem.vue'
import SearchInput from '@/Components/Element/SearchInput.vue'
import { listJob } from '@/API/job.js'

export default {
  components: { HospitalJobItem, SearchInput },
  created() {
    this.fetchData()
  },
  data: function () {
